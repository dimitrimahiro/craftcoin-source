...
{
    return GetBoolArg("-testnet", false) ? 17804 : 7804;
}
...
Value stop(const Array& params, bool fHelp)
{
    ...
    StartShutdown();
    return "CraftCoin server stopping";
}
...
void ThreadRPCServer(void* parg)
{
    ...
    RenameThread("craftcoin-rpclist");
...
void ThreadRPCServer2(void* parg)
{
        ...
        (mapArgs["-rpcuser"] == mapArgs["-rpcpassword"]))
    {
        ...
        string strWhatAmI = "To use craftcoind";
...
void ThreadRPCServer3(void* parg)
{
    ...
    RenameThread("craftcoin-rpchand");
